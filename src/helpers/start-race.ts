...
// const calculateRaceWinner = async (promises: RaceResult[], ids: unknown[]) => {
//     const { success, id, time } = await Promise.race(promises);
//     if (!success) {
//         const failedIndex = ids.findIndex((index: unknown) => index === id);
...
// export const startRace = async (promis) => {
